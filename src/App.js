    ...
    <div className="App">
      <Router>
        <Routes>
          ...
          <Route
            path="/sites-create"
            element={<AuthGuard component={<AddSites />} />}
          />
  
          <Route path="/sites" element={<AuthGuard component={<Sites />} />} />
          <Route
            path="/user-dashboard"
            element={<AuthGuard component={getComponentForUserRole()} />}
          />
          <Route path="/sites" element={<AuthGuard component={<Sites />} />} />
          <Route
            path="/view-permit"
            element={<AuthGuard component={<ViewPermit />} />}
          />
          <Route path="/maps" element={<AuthGuard component={<Maps />} />} />
          <Route path="/users" element={<AuthGuard component={<Users />} />} />
          <Route
            path="/all-permits"
            element={<AuthGuard component={<Permit />} />}
          />
          <Route
            path="/all-permits-create"
            element={<AuthGuard component={<AddPermit />} />}
          />
          <Route
            path="//my-permits"
            element={<AuthGuard component={<MyPermits />} />}
          />
          <Route
            path="/user-dashboard"
            element={<AuthGuard component={<Userashboard />} />}
          />
          <Route
            path="/my-permits"
            element={<AuthGuard component={<MyPermits />} />}
          ...
          <Route
            ...
            element={<AuthGuard component={<MyChildPermit />} />}
          />
          <Route
            path="/all-template"
            element={<AuthGuard component={<AllTemplates />} />}
          />
          <Route
            path="/account"
          ...
          <Route
            path="/forms-download"
            element={<AuthGuard component={<FormsDownlod />} />}
          />
          <Route
            path="/feedback-form"
